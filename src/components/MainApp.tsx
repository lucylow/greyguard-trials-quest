          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
            <div className="flex justify-center">
              <TabsList className="grid w-full max-w-4xl grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-1 sm:gap-2 bg-slate-100/50 backdrop-blur-sm p-1 rounded-xl shadow-lg border border-slate-200/50">
                ...
                <TabsTrigger value="fetch-agents" className="text-xs sm:text-sm px-3 sm:px-4 py-3 data-[state=active]:bg-white data-[state=active]:text-orange-600 data-[state=active]:shadow-md transition-all duration-200 rounded-lg hover:bg-white/50 data-[state=active]:border-l-4 data-[state=active]:border-l-4 data-[state=active]:border-l-orange-500">
                  <Bot className="h-4 w-4 mr-2 hidden sm:inline" /> Fetch.ai
                </TabsTrigger>
                <TabsTrigger value="chat" className="text-xs sm:text-sm px-3 sm:px-4 py-3 data-[state=active]:bg-white data-[state=active]:text-orange-600 data-[state=active]:shadow-md transition-all duration-200 rounded-lg hover:bg-white/50 data-[state=active]:border-l-4 data-[state=active]:border-l-4 data-[state=active]:border-l-orange-500">
                  <MessageSquare className="h-4 w-4 mr-2 hidden sm:inline" /> Chat
                </TabsTrigger>
                <TabsTrigger value="analytics" className="text-xs sm:text-sm px-3 sm:px-4 py-3 data-[state=active]:bg-white data-[state=active]:text-orange-600 data-[state=active]:shadow-md transition-all duration-200 rounded-lg hover:bg-white/50 data-[state=active]:border-l-4 data-[state=active]:border-l-4 data-[state=active]:border-l-green-500">
                  <TrendingUp className="h-4 w-4 mr-2 hidden sm:inline" /> Analytics
                </TabsTrigger>
                <TabsTrigger value="settings" className="text-xs sm:text-sm px-3 sm:px-4 py-3 data-[state=active]:bg-white data-[state=active]:text-orange-600 data-[state=active]:shadow-md transition-all duration-200 rounded-lg hover:bg-white/50 data-[state=active]:border-l-4 data-[state=active]:border-l-4 data-[state=active]:border-l-gray-500">
