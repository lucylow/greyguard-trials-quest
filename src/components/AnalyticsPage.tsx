...
export default function AnalyticsPage() {
  ...
  const proofTypes = [
    { id: 'age', name: 'Age Verification', description: 'Prove age without revealing exact date' },
    { id: 'medical', name: 'Medical History', description: 'Prove medical conditions without details' },
    { id: 'income', name: 'Income Verification', description: 'Prove income range without exact amount' },
    { id: 'location', name: 'Location Proof', description: 'Prove location without exact coordinates' }
  ];
      ...
      <div className="flex justify-center">
        <div className="flex space-x-1 bg-gray-100 p-1 rounded-lg">
          {[
            ...
            { id: 'zk-proofs', name: 'ZK Proofs', icon: Shield },
        ...
        <div className="space-y-6">
          ...
          <div className="text-center space-y-4">
            <div className="flex items-center justify-center space-x-3">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900">Zero Knowledge Proofs</h2>
      ...
      {activeTab === 'users' && (
        <div className="space-y-6">
          <Card>
            ...
            <CardContent>
              <div className="h-64 flex items-center justify-center text-gray-500">
                User analytics and demographics will be displayed here
              </div>
            </CardContent>
          </Card>
        </div>
